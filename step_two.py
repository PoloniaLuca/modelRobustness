...
def step_two(sims, aucs, nbs, briers, labels, texts, instances, samples_auc, samples_nb, samples_brier,
             ...
             offsets_y_brier, var_auc, var_nb, var_brier, options):
  ...
  elif o.discrimination_metric == "auc":
  ...
  if o.utility_metric == "wu":
    axs[1].set_xlabel("Weighted Utility")
  elif o.utility_metric == "snb":
    axs[1].set_xlabel("Standard Net Benefit")
  ...
  if o.calibration_metric == "brier":
    ...
    axs[2].set_ylim([0,1])
    plot_grid(axs[2], 0.25, 0.15, 0.08, 0.0, 0.46, 0.1, 0.3, 0.5, 0.9, 0.17, 0.10, 0.02, neg=True)
    axs[2].invert_xaxis()
    axs[2].yaxis.set_label_position("right")
    axs[2].yaxis.tick_right()
  elif o.calibration_metric == "eci":
    axs[2].set_xlabel("ECI")
    axs[2].set_xlim([-0.1, 1])
    axs[1].set_yticks([])
    axs[2].set_ylim([0,1])
    plot_grid(axs[2], 0.4, 0.6, 0.8, 1.0, -0.08, 0.1, 0.3, 0.5, 0.9, 0.555, 0.755, 0.955)
